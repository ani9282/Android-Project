...
public class Driver_show_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_show_profile);
        progressDialog=new ProgressDialog(Driver_show_profile.this);
        ...
        edit_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Driver_show_profile.this,Driver_edit_profile.class);
    ...
    public void onBackPressed() {
        ...
        finish();
        Intent intent = new Intent(Driver_show_profile.this, Driver_home_page.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflator.inflate(R.menu.driver_profile_change_password,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.password:
                Intent intent = new Intent(Driver_show_profile.this,Driver_change_password.class);
                startActivity(intent);
