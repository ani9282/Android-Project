...
public class DeliveredOrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderId = intent.getIntExtra(DeliveryOrdersAdapter.DELIVERED_ORDER_ID,0);
        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage(getString(R.string.loading));
        progressDialog.setCanceledOnTouchOutside(false);
        tvOrderId = findViewById(R.id.dodTextview_orderId);
        tvPhone = findViewById(R.id.dodTextView_number);
        tvName = findViewById(R.id.dodTextView_name);
        tvAddress = findViewById(R.id.dodTextView_address);
        tvOrderStatus = findViewById(R.id.dodTextView_orderStatus);
        tvOrderQuantity = findViewById(R.id.dodTextView_quantity);
        tvOrderCost = findViewById(R.id.dodTextView_cost);
        tvMop = findViewById(R.id.dodTextView_mop);
        tvPaymentStatus = findViewById(R.id.dodTextView_ps);
        tvOrderDate = findViewById(R.id.dodTextView_date);
        tvOrderTime = findViewById(R.id.dodTextView_time);

        btnDeleteOrder = findViewById(R.id.dodButton_deleteOrder);
        btnRetainOrder = findViewById(R.id.dodButton_retainOrder);

        btnDeleteOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DeliveredOrderDetailsActivity.this);
    ...
    private class RetainOrder extends AsyncTask<Void,Void,String> {
        ...
        protected void onPostExecute(String s) {
            if (isSuccess) {
                ...
                Toast.makeText(DeliveredOrderDetailsActivity.this, getString(R.string.success), Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(DeliveredOrderDetailsActivity.this,AdminHomeActivity.class);
