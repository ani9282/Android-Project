...
public class Sender_edit_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sender_edit_profile);
        progressDialog=new ProgressDialog(Sender_edit_profile.this);
    ...
    private class UpdateData extends AsyncTask<Void,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(isSuccess==true)
            {
                AlertDialog.Builder dialog=new AlertDialog.Builder(Sender_edit_profile.this);
                ...
                dialog.setPositiveButton("OK",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,
                                                int which) {
                                Intent intent = new Intent(Sender_edit_profile.this,Sender_show_profile.class);
