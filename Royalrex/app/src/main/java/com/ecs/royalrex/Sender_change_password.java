...
public class Sender_change_password extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sender_change_password);
        progressDialog=new ProgressDialog(Sender_change_password.this);
        progressDialog.setMessage("Loading Please Wait.....");
        progressDialog.setCanceledOnTouchOutside(false);
        sharedPreferences = getSharedPreferences(sharedPrefFile,MODE_PRIVATE);
        editor = sharedPreferences.edit();
        mobile=sharedPreferences.getString("mobile","mobile");
        oldpass=sharedPreferences.getString("sender_password","sender_password");
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(old_password.getText().toString().isEmpty() || new_password.getText().toString().isEmpty() || confirm_password.getText().toString().isEmpty() || !new_password.getText().toString().equals(confirm_password.getText().toString()) || !old_password.getText().toString().equals(oldpass))
                {
                    ...
                    {
                        Toast.makeText(Sender_change_password.this,"New Password and Confirm Password Not Matched",Toast.LENGTH_SHORT).show();
                    }
                    ...
                    if(!old_password.getText().toString().equals(oldpass))
                    {
                        ...
                        Toast.makeText(Sender_change_password.this,"All Fill Field",Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private class SaveData extends AsyncTask<Void,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(isSuccess==true)
            {
                AlertDialog.Builder dialog=new AlertDialog.Builder(Sender_change_password.this);
                ...
                dialog.setPositiveButton("OK",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,
                                ...
                                editor.clear();
                                editor.apply();
                                Intent intent = new Intent(Sender_change_password.this,Login.class);
