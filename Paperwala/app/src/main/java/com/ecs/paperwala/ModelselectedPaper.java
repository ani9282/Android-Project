...
public class ModelselectedPaper
{
    ...
    public ModelselectedPaper(String paper_name, String paper_rate, String pamphlete_rate, String paper_qty, String pamphlete_qty, String paper_total, String pamphlete_total, String total_final_price) {
        this.paper_name = paper_name;
        this.paper_rate = paper_rate;
        this.pamphlete_rate = pamphlete_rate;
        this.paper_qty = paper_qty;
